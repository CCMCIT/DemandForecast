"""Unit test (no DB): the CMS mapper turns a CmsOutOfServiceUnitsDetail row into a
MappedOutOfService -- copies Units, carries and trims the Equipment/Location names."""
...
def _detail(**overrides):
    """A minimal stand-in for a CmsOutOfServiceUnitsDetail row."""
    base = dict(
